...
import imageOne from "../public/img_one.jpg";
import imageTwo from "../public/img_two.jpg";
import imageThree from "../public/img_three.jpg";
...
import imageSeven from "../public/img_seven.jpg";
...
export default function Home() {
  return (
    <main className="w-screen h-auto bg-black/95">
      <section className="w-full h-100 relative flex justify-center items-center ">
        <div className="bg-black/40 w-full h-full absolute z-10"></div>
        <Image src={imageTwo} fill priority alt="Food Image" />
        <div className="w-1/2 h-1/2 z-20 grid">
          ...
          <NormalBtn name="Order" href="/menu" />
        </div>
      ...
      <section className="w-full h-auto flex flex-col bg-black/90 sm:flex-row">
        <div className="w-full h-96 grid p-4">
          ...
          <h2>Our Story</h2>
          <p>
            Our restaurant is located in the sunny Eldoret City and cool Nakuru
            City.The ideology of the restaurant Origin Coffee Kenya was inspired
            by Kenyan Culture.The glazed facades on both sides of the building
            face the road with stunning views.
          </p>
          <NormalBtn name="About Us" href="/about" />
        </div>
        <div className="w-full h-96 p-4 sm:p-8">
          <div className="w-full h-full relative">
            <Image src={imageEight} fill priority alt="Food Image" />
          </div>
        </div>
      </section>
      <section className="w-full h-auto flex flex-col sm:flex-row-reverse">
        <div className="w-full h-96 grid p-8">
          ...
          <h2>Menu</h2>
          <p>
            If you want to enjoy the original Kenyan food and drink,then you are
            definitely at the right place,Origin Coffee Kenya!We promise that
            you and your family will not remain indifferent to our dishes.
          </p>
        ...
        <div className="w-full h-96 p-8 grid grid-cols-2 gap-4 relative items-center">
          <div className="w-36 h-36 relative place-self-center lg:place-self-end lg:w-40 lg:h-40">
            <Image src={imageFour} fill alt="Food Image" />
          </div>
          <div className="w-36 h-36 relative place-self-center lg:place-self-start lg:w-40 lg:h-40">
            <Image src={imageEleven} fill alt="Food Image" />
          </div>
          <div className="w-36 h-36 relative place-self-center lg:place-self-end lg:w-40 lg:h-40">
            <Image src={imageEight} fill alt="Food Image" />
          </div>
          <div className="w-36 h-36 relative place-self-center lg:place-self-start lg:w-40 lg:h-40">
            <Image src={imageNine} fill alt="Food Image" />
          </div>
        </div>
      </section>
      <section className="w-full h-auto flex flex-col  bg-black/90 sm:flex-row">
      ...
      <section className="w-full h-auto flex flex-col sm:flex-row-reverse">
        <div className="w-full h-96 grid p-8">
          ...
          <NormalBtn name="Kitchen & Team" href="/about" />
        </div>
